...
export function Tab({ active, icon, children }: TabProps) {
	return (
		<div
			className={clsx(
				`flex-1 flex-col h-full items-center px-2 text-gray-200 hover:text-gray-100 justify-center font-medium transition-colors duration-100 hover:bg-gray-500 cursor-pointer`,
